...
>>>>>>> Add remderers
  ...
  TwitterCldr.RBNFTokenizer = (function() {
    function RBNFTokenizer() {
      ...
      recognizers = [new TwitterCldr.TokenRecognizer("negative", new RegExp(/-x/)), new TwitterCldr.TokenRecognizer("improper_fraction", new RegExp(/x\.x/)), new TwitterCldr.TokenRecognizer("proper_fraction", new RegExp(/0\.x/)), new TwitterCldr.TokenRecognizer("master", new RegExp(/x\.0/)), new TwitterCldr.TokenRecognizer("equals", new RegExp(/\=/)), new TwitterCldr.TokenRecognizer("rule", new RegExp("%%?[[:word:]\-]+")), new TwitterCldr.TokenRecognizer("right_arrow", new RegExp(/>/)), new TwitterCldr.TokenRecognizer("left_arrow", new RegExp(/</)), new TwitterCldr.TokenRecognizer("open_bracket", new RegExp(/\[/)), new TwitterCldr.TokenRecognizer("close_bracket", new RegExp(/\]/)), new TwitterCldr.TokenRecognizer("decimal", new RegExp(/[0#][0#,\.]+/)), new TwitterCldr.TokenRecognizer("semicolon", new RegExp(/;/))];
      ...
      this.tokenizer = new TwitterCldr.Tokenizer(recognizers.append(new TokenRecognizer("plaintext", new RegExp(/[\s\S]/))), splitter);
    }
  ...
  TwitterCldr.RBNFTokenizer = (function() {
    function RBNFTokenizer(data_reader) {
  ...
  TwitterCldr.RBNF = (function() {
    ...
    RBNF.prototype.format = function(number, options) {
      var rule_group, rule_group_name, rule_set, rule_set_name, _ref, _ref1;
      if (options == null) {
        options = {};
      }
      rule_group_name = null;
      rule_set_name = null;
      if ((options['rule_group'] != null) && (options['rule_set'] != null)) {
        _ref = [default_cardinal_options['rule_group'], default_cardinal_options['rule_set']], rule_group_name = _ref[0], rule_set_name = _ref[1];
      } else {
        _ref1 = [options['rule_group'], options['rule_set']], rule_group_name = _ref1[0], rule_set_name = _ref1[1];
      }
      if ((rule_group = rule_group_by_name(rule_group_name)) != null) {
  ...
  TwitterCldr.NumberDataReader = (function() {
    function NumberDataReader(locale, options) {
      ...
      this.number_min = Math.pow(10, abbreviated_min_power);
      this.number_max = Math.pow(10, abbreviated_max_power + 1);
      this.base_path = ["numbers", "formats"];
      this.symbol_path = ["numbers", "symbols"];
      this.symbols = this.traverse(symbol_path);
      this.type_paths = {
      ...
      if (!((typeof type !== "undefined" && type !== null) && (this.type_paths[type] != null))) {
      ...
      switch (this.type) {
        case "decimal":
          this.formatter = TwitterCldr.DecimalFormatter;
          break;
        case "long_decimal":
          this.formatter = TwitterCldr.LongDecimalFormatter;
          break;
        case "short_decimal":
          this.formatter = TwitterCldr.ShortDecimalFormatter;
          break;
        case "currency":
          this.formatter = TwitterCldr.CurrencyFormatter;
          break;
        case "percent":
          this.formatter = TwitterCldr.PercentFormatter;
      }
      this.number_data = {};
      this.resource = {"af":{"af":{"numbers":{"formats":{"currency":{"number_system":"latn","patterns":{"default":"¤#,##0.00;(¤#,##0.00)"},"unit":{"one":"{0} {1}","other":"{0} {1}"}},"decimal":{"number_system":"latn","patterns":{"default":"#,##0.###","long":{"1000":"0
},"unit":{"one":"{0} {1}","other":"{0} {1}"}},"decimal":{"number_system":"latn","patterns":{"default":"#,##0.###","long":{"1000":"0 thousand","10000":"00 thousand","100000":"000 thousand","1000000":"0 million","10000000":"00 million","100000000":"000 million","1000000000":"0 billion","10000000000":"00 billion","100000000000":"000 billion","1000000000000":"0 trillion","10000000000000":"00 trillion","100000000000000":"000 trillion"},"short":{"1000":"0 ہزار","10000":"00 ہزار","100000":"0 لاکھ","1000000":"00 لاکھ","10000000":"0 کروڑ","100000000":"00 کروڑ","1000000000":"0 ارب","10000000000":"00 ارب","100000000000":"0 کھرب","1000000000000":"00 کھرب","10000000000000":"00T","100000000000000":"000T"}}},"percent":{"number_system":"latn","patterns":{"default":"#,##0%"}},"scientific":{"number_system":"latn","patterns":{"default":"#E0"}}},"symbols":{"alias":"","decimal":".","exponential":"E","group":",","infinity":"∞","list":";","minus_sign":"‎-","nan":"NaN","per_mille":"‰","percent_sign":"%","plus_sign":"‎+","superscripting_exponent":"×"}}}},"vi":{"vi":{"numbers":{"formats":{"currency":{"number_system":"latn","patterns":{"default":"#,##0.00 ¤"},"unit":{"one":"{0} {1}","other":"{0} {1}"}},"decimal":{"number_system":"latn","patterns":{"default":"#,##0.###","long":{"1000":"0 nghìn","10000":"00 nghìn","100000":"000 nghìn","1000000":"0 triệu","10000000":"00 triệu","100000000":"000 triệu","1000000000":"0 tỷ","10000000000":"00 tỷ","100000000000":"000 tỷ","1000000000000":"0 nghìn tỷ","10000000000000":"00 nghìn tỷ","100000000000000":"000 nghìn tỷ"},"short":{"1000":"0 N","10000":"00 N","100000":"000 N","1000000":"0 Tr","10000000":"00 Tr","100000000":"000 Tr","1000000000":"0 T","10000000000":"00 T","100000000000":"000 T","1000000000000":"0 NT","10000000000000":"00 NT","100000000000000":"000 NT"}}},"percent":{"number_system":"latn","patterns":{"default":"#,##0%"}},"scientific":{"number_system":"latn","patterns":{"default":"#E0"}}},"symbols":{"alias":"","decimal":",","exponential":"E","group":".","infinity":"∞","list":";","minus_sign":"-","nan":"NaN","per_mille":"‰","percent_sign":"%","plus_sign":"+","superscripting_exponent":"×"}}}},"zh":{"zh":{"numbers":{"formats":{"currency":{"number_system":"latn","patterns":{"default":"¤#,##0.00;(¤#,##0.00)"},"unit":{"one":"{0} {1}","other":"{0}{1}"}},"decimal":{"number_system":"latn","patterns":{"default":"#,##0.###","long":{"1000":"0千","10000":"0万","100000":"00万","1000000":"000万","10000000":"0000万","100000000":"0亿","1000000000":"00亿","10000000000":"000亿","100000000000":"0000亿","1000000000000":"0兆","10000000000000":"00兆","100000000000000":"000兆"},"short":{"1000":"0千","10000":"0万","100000":"00万","1000000":"000万","10000000":"0000万","100000000":"0亿","1000000000":"00亿","10000000000":"000亿","100000000000":"0000亿","1000000000000":"0兆","10000000000000":"00兆","100000000000000":"000兆"}}},"percent":{"number_system":"latn","patterns":{"default":"#,##0%"}},"scientific":{"number_system":"latn","patterns":{"default":"#E0"}}},"symbols":{"alias":"","decimal":".","exponential":"E","group":",","infinity":"∞","list":";","minus_sign":"-","nan":"NaN","per_mille":"‰","percent_sign":"%","plus_sign":"+","superscripting_exponent":"×"}}}},"zh-Hant":{"zh-Hant":{"numbers":{"formats":{"currency":{"number_system":"latn","patterns":{"default":"¤#,##0.00;(¤#,##0.00)"},"unit":{"one":"{0} {1}","other":"{0} {1}"}},"decimal":{"number_system":"latn","patterns":{"default":"#,##0.###","long":{"1000":"0 千","10000":"0萬","100000":"00萬","1000000":"000萬","10000000":"0000萬","100000000":"0億","1000000000":"00億","10000000000":"000億","100000000000":"0000億","1000000000000":"0兆","10000000000000":"00兆","100000000000000":"000兆"},"short":{"1000":"0K","10000":"00K","100000":"000K","1000000":"0M","10000000":"00M","100000000":"000M","1000000000":"0B","10000000000":"00B","100000000000":"000B","1000000000000":"0T","10000000000000":"00T","100000000000000":"000T"}}},"percent":{"number_system":"latn","patterns":{"default":"#,##0%"}},"scientific":{"number_system":"latn","patterns":{"default":"#E0"}}},"symbols":{"alias":"","decimal":".","exponential":"E","group":",","infinity":"∞","list":";","minus_sign":"-","nan":"非數值","per_mille":"‰","percent_sign":"%","plus_sign":"+","superscripting_exponent":"×"}}}}};
    }
    ...
    NumberDataReader.prototype.number_system_for = function(type) {
      return (this.traverse(this.base_path.append(type)) || {})["number_system"] || this.default_number_system;
    };
    ...
    NumberDataReader.prototype.pattern_for_number = function(pattern, number) {
      if (pattern instanceof Object) {
        return pattern[get_key_for(number)] || [pattern];
      } else {
        return pattern;
      }
    };
  ...
  TwitterCldr.RBNFNormalRuleFormatter = (function() {
    ...
    RBNFNormalRuleFormatter.prototype.format = function(number, rule) {
      var result, results, token, _i, _len;
      results = [];
      for (_i = 0, _len = tokens.length; _i < _len; _i++) {
        token = tokens[_i];
        result = this[token.type](number, rule, token);
        results = results.append(this.omit ? "" : result);
      }
      return results.join("");
    };
    ...
    RBNFNormalRuleFormatter.prototype.generate_replacement = function(number, rule, token) {
      ...
      if ((rule_set_name = token.rule_set_reference) != null) {
        return TwitterCldr.RBNFRuleFormatter.format(number, rule_group.rule_set_for(rule_set_name), rule_group, locale);
      } else if ((decimal_format = token.decimal_format) != null) {
        this.data_reader || (this.data_reader = new TwitterCldr.NumberDataReader(locale));
        ...
        this.decimal_formatter || (this.decimal_formatter = new TwitterCldr.NumberFormatter(this.data_reader));
        return this.decimal_formatter.format(decimal_tokens, number, {
          "type": "decimal"
        });
      } else {
        return TwitterCldr.RBNFRuleFormatter.format(number, rule_set, rule_group, locale);
      }
    };
  ...
  TwitterCldr.RBNFRule = (function() {
    ...
    RBNFRule.prototype.is_normal = function() {
      return !(is_master || is_improper_fraction || is_proper_fraction || is_negative);
    };
  ...
  TwitterCldr.RBNFRuleGroup = (function() {
    ...
    RBNFRuleGroup.prototype.rule_set_for = function(rule_set_name) {
      var rule_set, _i, _len;
      for (_i = 0, _len = rule_sets.length; _i < _len; _i++) {
        rule_set = rule_sets[_i];
  ...
  TwitterCldr.RBNFRuleSet = (function() {
    ...
    RBNFRuleSet.prototype.rule_for_value = function(rule) {
      var index;
      if ((index = rule_index_for(base_value)) != null) {
    ...
    RBNFRuleSet.prototype.numeric_rules = function() {
      ...
      _results = [];
      for (rules = _i = _ref = this.get_search_start_index(), _ref1 = rules.size; _i < _ref1; rules = _i += 1) {
        _results.push(rules[i]);
      }
      return _results;
    };
    ...
    RBNFRuleSet.prototype.fractional_rule_for = function(number) {
      ...
      index = this.get_get_search_start_index();
    ...
    RBNFRuleSet.prototype.normal_rule_for = function(number) {
      ...
      if ((rule = this.master_rule) != null) {
        ...
        if ((rule = this.rule_for_value(Math.abs(number))) != null) {
          use_prev_rule = rule.substitution_count === 2 && !rule.is_even_multiple_of(rule.base_value) && rule.is_even_multiple_of(number);
          if (use_prev_rule) {
          ...
          return this.rules[this.get_search_start_index()] || this.rules.first;
        }
      }
    };
    ...
    RBNFRuleSet.prototype.get_search_start_index = function() {
      ...
      for (i = _i = 0, _ref = this.rules.length; _i < _ref; i = _i += 1) {
        if (is_numeric(this.rules[i].base_value)) {
  ...
  TwitterCldr.RBNFRuleParser = (function(_super) {
    ...
    RBNFRuleParser.prototype.exchange = function(list) {
      return this[this.current_token().type](list);
    };

    RBNFRuleParser.prototype.equals = function(list) {
      var contents;
      contents = descriptor(this.current_token());
    ...
    RBNFRuleParser.prototype.add_and_advance = function(list) {
      list = list.append(this.current_token());
      this.next_token(this.current_token().type);
      return this.exchange(list);
    };
    ...
    RBNFRuleParser.prototype.descriptor = function(token) {
      ...
      while (this.current_token().type !== token.type) {
        contents.append(this.current_token().type());
        next_token(this.current_token().type);
      }
      return contents;
    };
