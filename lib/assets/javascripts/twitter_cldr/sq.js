...
(function() {
  ...
  TwitterCldr.NumberParser = (function() {
    ...
    NumberParser.prototype.parse = function(number_text, options) {
      var num, num_list, punct_list, result, separators, token, tokens, _i, _len;
      if (options == null) {
        options = {};
      }
      ...
      if (punct_list.slice(-1)[0] && punct_list.slice(-1)[0]["type"] === "decimal") {
        ...
        return result + parseInt(num_list.slice(-1)[0].value) / Math.pow(10.0, num_list.slice(-1)[0].value.length);
      } else {
