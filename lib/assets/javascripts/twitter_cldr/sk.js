...
(function() {
  ...
  TwitterCldr.TimespanFormatter = (function() {
    function TimespanFormatter() {
      ...
      this.patterns = {"ago":{"second":{"default":{"one":"Pred {0} sekundou","few":"Pred {0} sekundami","other":"Pred {0} sekundami"}},"minute":{"default":{"one":"Pred {0} minútou","few":"Pred {0} minútami","other":"Pred {0} minútami"}},"hour":{"default":{"one":"Pred {0} hodinou","few":"Pred {0} hodinami","other":"Pred {0} hodinami"}},"day":{"default":{"one":"Pred {0} dňom","few":"Pred {0} dňami","other":"Pred {0} dňami"}},"week":{"default":{"one":"Pred {0} týždňom","few":"Pred {0} týždňami","other":"Pred {0} týždňami"}},"month":{"default":{"one":"Pred {0} mesiacom","few":"Pred {0} mesiacmi","other":"Pred {0} mesiacmi"}},"year":{"default":{"one":"Pred {0} rokom","few":"Pred {0} rokmi","other":"Pred {0} rokmi"}}},"until":{"second":{"default":{"one":"O {0} sekundu","few":"O {0} sekundy","other":"O {0} sekúnd"}},"minute":{"default":{"one":"O {0} minútu","few":"O {0} minúty","other":"O {0} minút"}},"hour":{"default":{"one":"O {0} hodinu","few":"O {0} hodiny","other":"O {0} hodín"}},"day":{"default":{"one":"{0} deň","few":"O {0} dni","other":"O {0} dní"}},"week":{"default":{"one":"O {0} týždeň","few":"O {0} týždne","other":"O {0} týždňov"}},"month":{"default":{"one":"O {0} mesiac","few":"O {0} mesiace","other":"O {0} mesiacov"}},"year":{"default":{"one":"O {0} rok","few":"O {0} roky","other":"O {0} rokov"}}},"none":{"second":{"default":{"one":"{0} sekunda","few":"{0} sekundy","other":"{0} sekúnd"},"short":{"one":"{0} s","few":"{0} s","other":"{0} s"},"abbreviated":{"one":"{0} s.","few":"{0} s.","other":"{0} s."}},"minute":{"default":{"one":"{0} minúta","few":"{0} minúty","other":"{0} minút"},"short":{"one":"{0} min","few":"{0} min","other":"{0} min"},"abbreviated":{"one":"{0} min","few":"{0} min","other":"{0} min"}},"hour":{"default":{"one":"{0} hodina","few":"{0} hodiny","other":"{0} hodín"},"short":{"one":"{0} h","few":"{0} h","other":"{0} h"},"abbreviated":{"one":"{0} hod.","few":"{0} hod.","other":"{0} hod."}},"day":{"default":{"one":"{0} deň","few":"{0} dni","other":"{0} dní"},"short":{"one":"{0} d.","few":"{0} d.","other":"{0} d."},"abbreviated":{"one":"{0}d","few":"{0}d","other":"{0}d"}},"week":{"default":{"one":"{0} týždeň","few":"{0} týždne","other":"{0} týždňov"},"short":{"one":"{0} týžd.","few":"{0} týžd.","other":"{0} týžd."}},"month":{"default":{"one":"{0} mesiac","few":"{0} mesiace","other":"{0} mesiacov"},"short":{"one":"{0} mes.","few":"{0} mes.","other":"{0} mes."}},"year":{"default":{"one":"{0} rok","few":"{0} roky","other":"{0} rokov"},"short":{"one":"{0} r.","few":"{0} r.","other":"{0} r."}}}};
