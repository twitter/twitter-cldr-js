...
(function() {
  ...
  TwitterCldr.PluralRules = (function() {
    ...
    PluralRules.rules = {ordinals: (function(num, runtime) { var n = runtime.n(num); var i = runtime.i(num); var v = runtime.v(num); var w = runtime.w(num); var f = runtime.f(num); var t = runtime.t(num); return (n == 4 ? 'few' : (n == 6 ? 'many' : (((n == 1) || (n == 5) || (n == 7) || (n == 8) || (n == 9) || (n == 10)) ? 'one' : (((n == 2) || (n == 3)) ? 'two' : 'other')))); }), plurals: (function(num, runtime) { var n = runtime.n(num); var i = runtime.i(num); var v = runtime.v(num); var w = runtime.w(num); var f = runtime.f(num); var t = runtime.t(num); return ((i == 0 || n == 1) ? 'one' : 'other'); })};
...
;
    ...
    PluralRules.names = {
      ordinals: ["few", "many", "one", "other", "two"],
      plurals: ["one", "other"]
    };
