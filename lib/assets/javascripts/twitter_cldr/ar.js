...
(function() {
  ...
  TwitterCldr.PluralRules = (function() {
    ...
    PluralRules.rules = {cardinal: (function(num, runtime) { var n = runtime.__n(num); var i = runtime.__i(num); var v = runtime.__v(num); var w = runtime.__w(num); var f = runtime.__f(num); var t = runtime.__t(num); return (((n % 100 >= 3) && (n % 100 <= 10)) ? 'few' : (((n % 100 >= 11) && (n % 100 <= 99)) ? 'many' : (n == 1 ? 'one' : (n == 2 ? 'two' : (n == 0 ? 'zero' : 'other'))))); }), ordinal: (function(num, runtime) { var n = runtime.__n(num); var i = runtime.__i(num); var v = runtime.__v(num); var w = runtime.__w(num); var f = runtime.__f(num); var t = runtime.__t(num); return 'other'; })};
