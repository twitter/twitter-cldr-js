...
(function() {
  ...
  TwitterCldr.TimespanFormatter = (function() {
    function TimespanFormatter() {
      ...
      this.patterns = {"ago":{"second":{"default":{"other":"{0} másodperccel ezelőtt"}},"minute":{"default":{"other":"{0} perccel ezelőtt"}},"hour":{"default":{"other":"{0} órával ezelőtt"}},"day":{"default":{"other":"{0} napja"}},"week":{"default":{"other":"{0} héttel ezelőtt"}},"month":{"default":{"other":"{0} hónappal ezelőtt"}},"year":{"default":{"other":"{0} évvel ezelőtt"}}},"until":{"second":{"default":{"other":"{0} másodperc múlva"}},"minute":{"default":{"other":"{0} perc múlva"}},"hour":{"default":{"other":"{0} óra múlva"}},"day":{"default":{"other":"{0} nap múlva"}},"week":{"default":{"other":"{0} hét múlva"}},"month":{"default":{"other":"{0} hónap múlva"}},"year":{"default":{"other":"{0} év múlva"}}},"none":{"second":{"default":{"other":"{0} másodperc"},"short":{"other":"{0} mp"},"abbreviated":{"other":"{0}mp"}},"minute":{"default":{"other":"{0} perc"},"short":{"other":"{0} p"},"abbreviated":{"other":"{0}p"}},"hour":{"default":{"other":"{0} óra"},"short":{"other":"{0} ó"},"abbreviated":{"other":"{0}ó"}},"day":{"default":{"other":"{0} nap"},"short":{"other":"{0} nap"},"abbreviated":{"other":"{0}n"}},"week":{"default":{"other":"{0} hét"},"short":{"other":"{0} hét"}},"month":{"default":{"other":"{0} hónap"},"short":{"other":"{0} hónap"}},"year":{"default":{"other":"{0} év"},"short":{"other":"{0} év"}}}};
