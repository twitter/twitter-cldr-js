...
;
  ...
  TwitterCldr.TimespanFormatter = (function() {
    function TimespanFormatter() {
      ...
      this.patterns = {"ago":{"second":{"default":{"one":"{0} second ago","other":"{0}秒前"}},"minute":{"default":{"one":"{0} minute ago","other":"{0}分前"}},"hour":{"default":{"one":"{0} hour ago","other":"{0}時間前"}},"day":{"default":{"one":"{0} day ago","other":"{0}日前"}},"week":{"default":{"one":"{0} week ago","other":"{0}週前"}},"month":{"default":{"one":"{0} month ago","other":"{0}か月前"}},"year":{"default":{"one":"{0} year ago","other":"{0}年前"}}},"until":{"second":{"default":{"one":"In {0} second","other":"{0}秒後"}},"minute":{"default":{"one":"In {0} minute","other":"{0}分後"}},"hour":{"default":{"one":"In {0} hour","other":"{0}時間後"}},"day":{"default":{"one":"In {0} day","other":"{0}日後"}},"week":{"default":{"one":"In {0} week","other":"{0} 週間後"}},"month":{"default":{"one":"In {0} month","other":"{0}か月後"}},"year":{"default":{"one":"In {0} year","other":"{0}年後"}}},"none":{"second":{"default":{"one":"{0} second","other":"{0}秒"},"short":{"one":"{0} sec","other":"{0}秒"},"abbreviated":{"one":"{0}秒","other":"{0}秒"}},"minute":{"default":{"one":"{0} minute","other":"{0}分"},"short":{"one":"{0} min","other":"{0}分"},"abbreviated":{"one":"{0}分","other":"{0}分"}},"hour":{"default":{"one":"{0} hour","other":"{0}時間"},"short":{"one":"{0} hr","other":"{0}時間"},"abbreviated":{"one":"{0}時間","other":"{0}時間"}},"day":{"default":{"one":"{0} day","other":"{0}日"},"short":{"one":"{0} day","other":"{0}日"},"abbreviated":{"one":"{0}日","other":"{0}日"}},"week":{"default":{"one":"{0} week","other":"{0}週"},"short":{"one":"{0} wk","other":"{0}週"}},"month":{"default":{"one":"{0} month","other":"{0}か月"},"short":{"one":"{0} mth","other":"{0}か月"}},"year":{"default":{"one":"{0} year","other":"{0}年"},"short":{"one":"{0} yr","other":"{0}年"}}}};
