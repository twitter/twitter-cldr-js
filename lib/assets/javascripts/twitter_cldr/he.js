...
(function() {
  ...
  TwitterCldr.PluralRules = (function() {
    ...
    PluralRules.rule = (function(num, runtime) { var n = runtime.n(num); var i = runtime.i(num); var v = runtime.v(num); var w = runtime.w(num); var f = runtime.f(num); var t = runtime.t(num); return (((v == 0 && !((n >= 0) && (n <= 10))) && n % 10 == 0) ? 'many' : ((i == 1 && v == 0) ? 'one' : ((i == 2 && v == 0) ? 'two' : 'other'))); });
...
;
    ...
    PluralRules.names = ["many", "one", "other", "two"];
