...
(function() {
  ...
  TwitterCldr.TimespanFormatter = (function() {
    function TimespanFormatter() {
      ...
      this.patterns = {"ago":{"second":{"default":{"one":"před {0} sekundou","few":"před {0} sekundami","other":"před {0} sekundami"}},"minute":{"default":{"one":"před {0} minutou","few":"před {0} minutami","other":"před {0} minutami"}},"hour":{"default":{"one":"před {0} hodinou","few":"před {0} hodinami","other":"před {0} hodinami"}},"day":{"default":{"one":"před {0} dnem","few":"před {0} dny","other":"před {0} dny"}},"week":{"default":{"one":"před {0} týdnem","few":"před {0} týdny","other":"před {0} týdny"}},"month":{"default":{"one":"před {0} měsícem","few":"před {0} měsíci","other":"před {0} měsíci"}},"year":{"default":{"one":"před {0} rokem","few":"před {0} lety","other":"před {0} lety"}}},"until":{"second":{"default":{"one":"za {0} sekundu","few":"za {0} sekundy","other":"za {0} sekund"}},"minute":{"default":{"one":"za {0} minutu","few":"za {0} minuty","other":"za {0} minut"}},"hour":{"default":{"one":"za {0} hodinu","few":"za {0} hodiny","other":"za {0} hodin"}},"day":{"default":{"one":"za {0} den","few":"za {0} dny","other":"za {0} dní"}},"week":{"default":{"one":"za {0} týden","few":"za {0} týdny","other":"za {0} týdnů"}},"month":{"default":{"one":"za {0} měsíc","few":"za {0} měsíce","other":"za {0} měsíců"}},"year":{"default":{"one":"za {0} rok","few":"za {0} roky","other":"za {0} let"}}},"none":{"second":{"default":{"one":"{0} sekunda","few":"{0} sekundy","other":"{0} sekund"},"short":{"one":"{0} sek.","few":"{0} sek.","other":"{0} sek."},"abbreviated":{"one":"{0}sec","few":"{0}sec","other":"{0}sec"}},"minute":{"default":{"one":"{0} minuta","few":"{0} minuty","other":"{0} minut"},"short":{"one":"{0} min.","few":"{0} min.","other":"{0} min."},"abbreviated":{"one":"{0} min","few":"{0} min","other":"{0} min"}},"hour":{"default":{"one":"{0} hodina","few":"{0} hodiny","other":"{0} hodin"},"short":{"one":"{0} hod.","few":"{0} hod.","other":"{0} hod."},"abbreviated":{"one":"{0}hod","few":"{0}hod","other":"{0}hod"}},"day":{"default":{"one":"{0} den","few":"{0} dny","other":"{0} dní"},"short":{"one":"{0} den","few":"{0} dny","other":"{0} dní"},"abbreviated":{"one":"{0}dnů","few":"{0}dnů","other":"{0}dnů"}},"week":{"default":{"one":"{0} týden","few":"{0} týdny","other":"{0} týdnů"},"short":{"one":"{0} týd.","few":"{0} týd.","other":"{0} týd."}},"month":{"default":{"one":"{0} měsíc","few":"{0} měsíce","other":"{0} měsíců"},"short":{"one":"{0} měs.","few":"{0} měs.","other":"{0} měs."}},"year":{"default":{"one":"{0} rok","few":"{0} roky","other":"{0} let"},"short":{"one":"{0} rok","few":"{0} roky","other":"{0} let"}}}};
