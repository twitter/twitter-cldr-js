...
(function() {
  ...
  TwitterCldr.TimespanFormatter = (function() {
    function TimespanFormatter() {
      ...
      this.patterns = {"ago":{"second":{"default":{"one":"пре {0} секунд","few":"пре {0} секунде","many":"пре {0} секунди","other":"пре {0} секунди"}},"minute":{"default":{"one":"пре {0} минут","few":"пре {0} минута","many":"пре {0} минута","other":"пре {0} минута"}},"hour":{"default":{"one":"пре {0} сат","few":"пре {0} сата","many":"пре {0} сати","other":"пре {0} сати"}},"day":{"default":{"one":"пре {0} дан","few":"пре {0} дана","many":"пре {0} дана","other":"пре {0} дана"}},"week":{"default":{"one":"пре {0} недељу","few":"пре {0} недеље","many":"пре {0} недеља","other":"пре {0} недеља"}},"month":{"default":{"one":"пре {0} месец","few":"пре {0} месеца","many":"пре {0} месеци","other":"пре {0} месеци"}},"year":{"default":{"one":"пре {0} годину","few":"пре {0} године","many":"пре {0} година","other":"пре {0} година"}}},"until":{"second":{"default":{"one":"за {0} секунд","few":"за {0} секунде","many":"за {0} секунди","other":"за {0} секунди"}},"minute":{"default":{"one":"за {0} минут","few":"за {0} минута","many":"за {0} минута","other":"за {0} минута"}},"hour":{"default":{"one":"за {0} сат","few":"за {0} сата","many":"за {0} сати","other":"за {0} сати"}},"day":{"default":{"one":"за {0} дан","few":"за {0} дана","many":"за {0} дана","other":"за {0} дана"}},"week":{"default":{"one":"за {0} недељу","few":"за {0} недеље","many":"за {0} недеља","other":"за {0} недеља"}},"month":{"default":{"one":"за {0} месец","few":"за {0} месеца","many":"за {0} месеци","other":"за {0} месеци"}},"year":{"default":{"one":"за {0} годину","few":"за {0} године","many":"за {0} година","other":"за {0} година"}}},"none":{"second":{"default":{"one":"{0} секунда","few":"{0} секунде","many":"{0} секунди","other":"{0} секунда"},"short":{"one":"{0} сек","few":"{0} сек","many":"{0} сек","other":"{0} сек"},"abbreviated":{"one":"{0}с","few":"{0}с","many":"{0}с","other":"{0}с"}},"minute":{"default":{"one":"{0} минут","few":"{0} минута","many":"{0} минута","other":"{0} минут"},"short":{"one":"{0} мин","few":"{0} мин","many":"{0} мин","other":"{0} мин"},"abbreviated":{"one":"{0}м","few":"{0}м","many":"{0}м","other":"{0}м"}},"hour":{"default":{"one":"{0} сат","few":"{0} сата","many":"{0} сати","other":"{0} сат"},"short":{"one":"{0} сат","few":"{0} сата","many":"{0} сати","other":"{0} сат"},"abbreviated":{"one":"{0}с","few":"{0}с","many":"{0}с","other":"{0}с"}},"day":{"default":{"one":"{0} дан","few":"{0} дана","many":"{0} дана","other":"{0} дан"},"short":{"one":"{0} дан","few":"{0} дана","many":"{0} дана","other":"{0} дан"},"abbreviated":{"one":"{0}д","few":"{0}д","many":"{0}д","other":"{0}д"}},"week":{"default":{"one":"{0} недеља","few":"{0} недеље","many":"{0} недеља","other":"{0} недеља"},"short":{"one":"{0} нед","few":"{0} нед","many":"{0} нед","other":"{0} нед"}},"month":{"default":{"one":"{0} месец","few":"{0} месеца","many":"{0} месеци","other":"{0} месец"},"short":{"one":"{0} мес","few":"{0} мес","many":"{0} мес","other":"{0} мес"}},"year":{"default":{"one":"{0} година","few":"{0} године","many":"{0} година","other":"{0} година"},"short":{"one":"{0} год","few":"{0} год","many":"{0} год","other":"{0} год"}}}};
