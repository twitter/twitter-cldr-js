...
(function() {
  ...
  TwitterCldr.TimespanFormatter = (function() {
    function TimespanFormatter() {
      ...
      this.patterns = {"ago":{"second":{"default":{"other":"{0} ثانیه پیش"}},"minute":{"default":{"other":"{0} دقیقه پیش"}},"hour":{"default":{"other":"{0} ساعت پیش"}},"day":{"default":{"other":"{0} روز پیش"}},"week":{"default":{"other":"{0} هفته پیش"}},"month":{"default":{"other":"{0} ماه پیش"}},"year":{"default":{"other":"{0} سال پیش"}}},"until":{"second":{"default":{"other":"{0} ثانیه بعد"}},"minute":{"default":{"other":"{0} دقیقه بعد"}},"hour":{"default":{"other":"{0} ساعت بعد"}},"day":{"default":{"other":"{0} روز بعد"}},"week":{"default":{"other":"{0} هفته بعد"}},"month":{"default":{"other":"{0} ماه بعد"}},"year":{"default":{"other":"{0} سال بعد"}}},"none":{"second":{"default":{"other":"{0} ثانیه"},"short":{"other":"{0} ثانیه"},"abbreviated":{"other":"{0} ثانیه"}},"minute":{"default":{"other":"{0} دقیقه"},"short":{"other":"{0} دقیقه"},"abbreviated":{"other":"{0} دقیقه"}},"hour":{"default":{"other":"{0} ساعت"},"short":{"other":"{0} ساعت"},"abbreviated":{"other":"{0} ساعت"}},"day":{"default":{"other":"{0} روز"},"short":{"other":"{0} روز"},"abbreviated":{"other":"{0} روز"}},"week":{"default":{"other":"{0} هفته"},"short":{"other":"{0} هفته"}},"month":{"default":{"other":"{0} ماه"},"short":{"other":"{0} ماه"}},"year":{"default":{"other":"{0} سال"},"short":{"other":"{0} سال"}}}};
