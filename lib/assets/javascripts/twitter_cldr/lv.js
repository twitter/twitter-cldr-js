...
(function() {
  ...
  TwitterCldr.PluralRules = (function() {
    ...
    PluralRules.rule = (function(num, runtime) { var n = runtime.n(num); var i = runtime.i(num); var v = runtime.v(num); var w = runtime.w(num); var f = runtime.f(num); var t = runtime.t(num); return ((((n % 10 == 1 && n % 100 != 11) || ((v == 2 && f % 10 == 1) && f % 100 != 11)) || (v != 2 && f % 10 == 1)) ? 'one' : (((n % 10 == 0 || ((n % 100 >= 11) && (n % 100 <= 19))) || (v == 2 && ((f % 100 >= 11) && (f % 100 <= 19)))) ? 'zero' : 'other')); });
...
;
    ...
    PluralRules.names = ["one", "other", "zero"];
