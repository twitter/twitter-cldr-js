...
(function() {
  ...
  TwitterCldr.PluralRules = (function() {
    ...
    PluralRules.rules = {cardinal: (function(num, runtime) { var n = runtime.__n(num); var i = runtime.__i(num); var v = runtime.__v(num); var w = runtime.__w(num); var f = runtime.__f(num); var t = runtime.__t(num); return ((i == 1 && v == 0) ? 'one' : 'other'); }), ordinal: (function(num, runtime) { var n = runtime.__n(num); var i = runtime.__i(num); var v = runtime.__v(num); var w = runtime.__w(num); var f = runtime.__f(num); var t = runtime.__t(num); return ((n % 10 == 3 && n % 100 != 13) ? 'few' : ((n % 10 == 1 && n % 100 != 11) ? 'one' : ((n % 10 == 2 && n % 100 != 12) ? 'two' : 'other'))); })};
