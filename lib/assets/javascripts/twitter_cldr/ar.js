...
(function() {
  ...
  TwitterCldr.PluralRules = (function() {
    ...
    PluralRules.rule = (function(num, runtime) { var n = runtime.n(num); var i = runtime.i(num); var v = runtime.v(num); var w = runtime.w(num); var f = runtime.f(num); var t = runtime.t(num); return (((n % 100 >= 3) && (n % 100 <= 10)) ? 'few' : (((n % 100 >= 11) && (n % 100 <= 99)) ? 'many' : (n == 1 ? 'one' : (n == 2 ? 'two' : (n == 0 ? 'zero' : 'other'))))); });
...
;
    ...
    PluralRules.names = ["few", "many", "one", "other", "two", "zero"];
