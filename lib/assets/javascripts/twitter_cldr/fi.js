...
;
  ...
  TwitterCldr.NumberFormatter = (function() {
    function NumberFormatter() {
      ...
      this.tokens = [];
      this.symbols = {"alias":"","decimal":",","exponential":"E","group":" ","infinity":"∞","list":";","minus_sign":"−","nan":"epäluku","per_mille":"‰","percent_sign":"%","plus_sign":"+","superscripting_exponent":"×","time_separator":"."};
