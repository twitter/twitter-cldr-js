...
(function() {
  ...
  TwitterCldr.PluralRules = (function() {
    ...
    PluralRules.rules = {ordinals: (function(num, runtime) { var n = runtime.n(num); var i = runtime.i(num); var v = runtime.v(num); var w = runtime.w(num); var f = runtime.f(num); var t = runtime.t(num); return ((n % 10 == 3 && n % 100 != 13) ? 'few' : ((n % 10 == 1 && n % 100 != 11) ? 'one' : ((n % 10 == 2 && n % 100 != 12) ? 'two' : 'other'))); }), plurals: (function(num, runtime) { var n = runtime.n(num); var i = runtime.i(num); var v = runtime.v(num); var w = runtime.w(num); var f = runtime.f(num); var t = runtime.t(num); return ((i == 1 && v == 0) ? 'one' : 'other'); })};
...
;
  ...
  TwitterCldr.TimespanFormatter = (function() {
    function TimespanFormatter() {
      ...
      this.patterns = {"ago":{"second":{"default":{"one":"{0} second ago","other":"{0} detik yang lalu"}},"minute":{"default":{"one":"{0} minute ago","other":"{0} menit yang lalu"}},"hour":{"default":{"one":"{0} hour ago","other":"{0} jam yang lalu"}},"day":{"default":{"one":"{0} day ago","other":"{0} hari yang lalu"}},"week":{"default":{"one":"{0} week ago","other":"{0} minggu yang lalu"}},"month":{"default":{"one":"{0} month ago","other":"{0} bulan yang lalu"}},"year":{"default":{"one":"{0} year ago","other":"{0} tahun yang lalu"}}},"until":{"second":{"default":{"one":"In {0} second","other":"Dalam {0} detik"}},"minute":{"default":{"one":"In {0} minute","other":"Dalam {0} menit"}},"hour":{"default":{"one":"In {0} hour","other":"Dalam {0} jam"}},"day":{"default":{"one":"In {0} day","other":"Dalam {0} hari"}},"week":{"default":{"one":"In {0} week","other":"Dalam {0} minggu"}},"month":{"default":{"one":"In {0} month","other":"Dalam {0} bulan"}},"year":{"default":{"one":"In {0} year","other":"Dalam {0} tahun"}}},"none":{"second":{"default":{"one":"{0} second","other":"{0} detik"},"short":{"one":"{0} sec","other":"{0} dtk"},"abbreviated":{"one":"{0} detik","other":"{0} detik"}},"minute":{"default":{"one":"{0} minute","other":"{0} menit"},"short":{"one":"{0} min","other":"{0} mnt"},"abbreviated":{"one":"{0} menit","other":"{0} menit"}},"hour":{"default":{"one":"{0} hour","other":"{0} jam"},"short":{"one":"{0} hr","other":"{0} jam"},"abbreviated":{"one":"{0} jam","other":"{0} jam"}},"day":{"default":{"one":"{0} day","other":"{0} hari"},"short":{"one":"{0} day","other":"{0} hr"},"abbreviated":{"one":"{0} hari","other":"{0} hari"}},"week":{"default":{"one":"{0} week","other":"{0} minggu"},"short":{"one":"{0} wk","other":"{0} mggu"}},"month":{"default":{"one":"{0} month","other":"{0} bulan"},"short":{"one":"{0} mth","other":"{0} bln"}},"year":{"default":{"one":"{0} year","other":"{0} tahun"},"short":{"one":"{0} yr","other":"{0} thn"}}}};
