...
(function() {
  ...
  TwitterCldr.PluralRules = (function() {
    ...
    PluralRules.rule = (function(num, runtime) { var n = runtime.n(num); var i = runtime.i(num); var v = runtime.v(num); var w = runtime.w(num); var f = runtime.f(num); var t = runtime.t(num); return (((n >= 3) && (n <= 6)) ? 'few' : (((n >= 7) && (n <= 10)) ? 'many' : (n == 1 ? 'one' : (n == 2 ? 'two' : 'other')))); });
...
;
    ...
    PluralRules.names = ["few", "many", "one", "other", "two"];
