...
(function() {
  ...
  TwitterCldr.TimespanFormatter = (function() {
    function TimespanFormatter() {
      ...
      this.patterns = {"ago":{"second":{"default":{"one":"prije {0} sekundu","few":"prije {0} sekunde","many":"prije {0} sekundi","other":"prije {0} sekundi"}},"minute":{"default":{"one":"prije {0} minutu","few":"prije {0} minute","many":"prije {0} minuta","other":"prije {0} minuta"}},"hour":{"default":{"one":"prije {0} sat","few":"prije {0} sata","many":"prije {0} sati","other":"prije {0} sati"}},"day":{"default":{"one":"prije {0} dan","few":"prije {0} dana","many":"prije {0} dana","other":"prije {0} dana"}},"week":{"default":{"one":"prije {0} tjedan","few":"prije {0} tjedna","many":"prije {0} tjedana","other":"prije ovoliko tjedana: {0}"}},"month":{"default":{"one":"prije {0} mjesec","few":"prije {0} mjeseca","many":"prije {0} mjeseci","other":"prije ovoliko mjeseci: {0}"}},"year":{"default":{"one":"prije {0} godinu","few":"prije {0} godine","many":"prije {0} godina","other":"prije ovoliko godina: {0}"}}},"until":{"second":{"default":{"one":"za {0} sekundu","few":"za {0} sekunde","many":"za {0} sekundi","other":"za {0} sekundi"}},"minute":{"default":{"one":"za {0} minutu","few":"za {0} minute","many":"za {0} minuta","other":"za {0} minuta"}},"hour":{"default":{"one":"za {0} sat","few":"za {0} sata","many":"za {0} sati","other":"za {0} sati"}},"day":{"default":{"one":"za {0} dan","few":"za {0} dana","many":"za {0} dana","other":"za {0} dana"}},"week":{"default":{"one":"za {0} tjedan","few":"za {0} tjedna","many":"za {0} tjedana","other":"za sljedeći broj tjedana: {0}"}},"month":{"default":{"one":"za {0} mjesec","few":"za {0} mjeseca","many":"za {0} mjeseci","other":"za sljedeći broj mjeseci: {0}"}},"year":{"default":{"one":"za {0} godinu","few":"za {0} godine","many":"za {0} godina","other":"za {0} godina"}}},"none":{"second":{"default":{"one":"{0} sekunda","few":"{0} sekunde","many":"{0} sekundi","other":"{0} sekunda"},"short":{"one":"{0} s","few":"{0} s","many":"{0} s","other":"{0} s"},"abbreviated":{"one":"{0}s","few":"{0}s","many":"{0}s","other":"{0}s"}},"minute":{"default":{"one":"{0} minuta","few":"{0} minute","many":"{0} minuta","other":"{0} minuta"},"short":{"one":"{0} min","few":"{0} min","many":"{0} min","other":"{0} min"}},"hour":{"default":{"one":"{0} sat","few":"{0} sata","many":"{0} sati","other":"{0} sata"},"short":{"one":"{0} h","few":"{0} h","many":"{0} h","other":"{0} h"}},"day":{"default":{"one":"{0} dan","few":"{0} dana","many":"{0} dana","other":"{0} dan"},"short":{"one":"{0} dan","few":"{0} dana","many":"{0} dana","other":"{0} dan"}},"week":{"default":{"one":"{0} tjedan","few":"{0} tjedna","many":"{0} tjedana","other":"{0} tjedan"},"short":{"one":"{0} tj.","few":"{0} tj.","many":"{0} tj.","other":"{0} tj."}},"month":{"default":{"one":"{0} mjesec","few":"{0} mjeseca","many":"{0} mjeseci","other":"{0} mjesec"},"short":{"one":"{0} mj.","few":"{0} mj.","many":"{0} mj.","other":"{0} mj."}},"year":{"default":{"one":"{0} godina","few":"{0} godine","many":"{0} godina","other":"{0} godina"},"short":{"one":"{0} g.","few":"{0} g.","many":"{0} g.","other":"{0} g."}}}};
