...
(function() {
  ...
  TwitterCldr.PluralRules = (function() {
    ...
    PluralRules.rule = (function(num, runtime) { var n = runtime.n(num); var i = runtime.i(num); var v = runtime.v(num); var w = runtime.w(num); var f = runtime.f(num); var t = runtime.t(num); return ((((n % 10 >= 2) && (n % 10 <= 4)) && !((n % 100 >= 12) && (n % 100 <= 14))) ? 'few' : (((n % 10 == 0 || ((n % 10 >= 5) && (n % 10 <= 9))) || ((n % 100 >= 11) && (n % 100 <= 14))) ? 'many' : ((n % 10 == 1 && n % 100 != 11) ? 'one' : 'other'))); });
