...
;
  ...
  TwitterCldr.TimespanFormatter = (function() {
    function TimespanFormatter() {
      ...
      this.patterns = {"ago":{"second":{"default":{"one":"{0} second ago","other":"{0} saat lalu"}},"minute":{"default":{"one":"{0} minute ago","other":"{0} minit lalu"}},"hour":{"default":{"one":"{0} hour ago","other":"{0} jam lalu"}},"day":{"default":{"one":"{0} day ago","other":"{0} hari lalu"}},"week":{"default":{"one":"{0} week ago","other":"{0} minggu lalu"}},"month":{"default":{"one":"{0} month ago","other":"{0} bulan lalu"}},"year":{"default":{"one":"{0} year ago","other":"{0} tahun lalu"}}},"until":{"second":{"default":{"one":"In {0} second","other":"Dalam {0} saat"}},"minute":{"default":{"one":"In {0} minute","other":"Dalam {0} minit"}},"hour":{"default":{"one":"In {0} hour","other":"Dalam {0} jam"}},"day":{"default":{"one":"In {0} day","other":"Dalam {0} hari"}},"week":{"default":{"one":"In {0} week","other":"Dalam {0} minggu"}},"month":{"default":{"one":"In {0} month","other":"Dalam {0} bulan"}},"year":{"default":{"one":"In {0} year","other":"Dalam {0} tahun"}}},"none":{"second":{"default":{"one":"{0} second","other":"{0} saat"},"short":{"one":"{0} sec","other":"{0} saat"},"abbreviated":{"one":"{0} saat","other":"{0} saat"}},"minute":{"default":{"one":"{0} minute","other":"{0} minit"},"short":{"one":"{0} min","other":"{0} min"},"abbreviated":{"one":"{0} m","other":"{0} m"}},"hour":{"default":{"one":"{0} hour","other":"{0} jam"},"short":{"one":"{0} hr","other":"{0} jam"},"abbreviated":{"one":"{0}j","other":"{0}j"}},"day":{"default":{"one":"{0} day","other":"{0} hari"},"short":{"one":"{0} day","other":"{0} hari"},"abbreviated":{"one":"{0}h","other":"{0}h"}},"week":{"default":{"one":"{0} week","other":"{0} minggu"},"short":{"one":"{0} wk","other":"{0} minggu"}},"month":{"default":{"one":"{0} month","other":"{0} bulan"},"short":{"one":"{0} mth","other":"{0} bulan"}},"year":{"default":{"one":"{0} year","other":"{0} tahun"},"short":{"one":"{0} yr","other":"{0} thn"}}}};
