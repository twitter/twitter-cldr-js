...
;
  ...
  TwitterCldr.TimespanFormatter = (function() {
    function TimespanFormatter() {
      ...
      this.patterns = {"ago":{"second":{"default":{"one":"{0} second ago","other":"{0}秒钟前"}},"minute":{"default":{"one":"{0} minute ago","other":"{0}分钟前"}},"hour":{"default":{"one":"{0} hour ago","other":"{0}小时前"}},"day":{"default":{"one":"{0} day ago","other":"{0}天前"}},"week":{"default":{"one":"{0} week ago","other":"{0}周前"}},"month":{"default":{"one":"{0} month ago","other":"{0}个月前"}},"year":{"default":{"one":"{0} year ago","other":"{0}年前"}}},"until":{"second":{"default":{"one":"In {0} second","other":"{0}秒钟后"}},"minute":{"default":{"one":"In {0} minute","other":"{0}分钟后"}},"hour":{"default":{"one":"In {0} hour","other":"{0}小时后"}},"day":{"default":{"one":"In {0} day","other":"{0}天后"}},"week":{"default":{"one":"In {0} week","other":"{0}周后"}},"month":{"default":{"one":"In {0} month","other":"{0}个月后"}},"year":{"default":{"one":"In {0} year","other":"{0}年后"}}},"none":{"second":{"default":{"one":"{0} second","other":"{0}秒钟"},"short":{"one":"{0} sec","other":"{0}秒"},"abbreviated":{"one":"{0}秒","other":"{0}秒"}},"minute":{"default":{"one":"{0} minute","other":"{0}分钟"},"short":{"one":"{0} min","other":"{0}分"},"abbreviated":{"one":"{0}分","other":"{0}分"}},"hour":{"default":{"one":"{0} hour","other":"{0}小时"},"short":{"one":"{0} hr","other":"{0}小时"},"abbreviated":{"one":"{0}时","other":"{0}时"}},"day":{"default":{"one":"{0} day","other":"{0}天"},"short":{"one":"{0} day","other":"{0}天"},"abbreviated":{"one":"{0}天","other":"{0}天"}},"week":{"default":{"one":"{0} week","other":"{0}周"},"short":{"one":"{0} wk","other":"{0}周"}},"month":{"default":{"one":"{0} month","other":"{0}个月"},"short":{"one":"{0} mth","other":"{0}个月"}},"year":{"default":{"one":"{0} year","other":"{0}年"},"short":{"one":"{0} yr","other":"{0}年"}}}};
