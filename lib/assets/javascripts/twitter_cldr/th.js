...
;
  ...
  TwitterCldr.TimespanFormatter = (function() {
    function TimespanFormatter() {
      ...
      this.patterns = {"ago":{"second":{"default":{"one":"{0} second ago","other":"{0} วินาทีที่ผ่านมา"}},"minute":{"default":{"one":"{0} minute ago","other":"{0} นาทีที่ผ่านมา"}},"hour":{"default":{"one":"{0} hour ago","other":"{0} ชั่วโมงที่ผ่านมา"}},"day":{"default":{"one":"{0} day ago","other":"{0} วันที่ผ่านมา"}},"week":{"default":{"one":"{0} week ago","other":"{0} สัปดาห์ที่ผ่านมา"}},"month":{"default":{"one":"{0} month ago","other":"{0} เดือนที่ผ่านมา"}},"year":{"default":{"one":"{0} year ago","other":"{0} ปีที่แล้ว"}}},"until":{"second":{"default":{"one":"In {0} second","other":"ในอีก {0} วินาที"}},"minute":{"default":{"one":"In {0} minute","other":"ในอีก {0} นาที"}},"hour":{"default":{"one":"In {0} hour","other":"ในอีก {0} ชั่วโมง"}},"day":{"default":{"one":"In {0} day","other":"ในอีก {0} วัน"}},"week":{"default":{"one":"In {0} week","other":"ในอีก {0} สัปดาห์"}},"month":{"default":{"one":"In {0} month","other":"ในอีก {0} เดือน"}},"year":{"default":{"one":"In {0} year","other":"ในอีก {0} ปี"}}},"none":{"second":{"default":{"one":"{0} second","other":"{0} วินาที"},"short":{"one":"{0} sec","other":"{0} วิ"},"abbreviated":{"one":"{0} วินาที","other":"{0} วินาที"}},"minute":{"default":{"one":"{0} minute","other":"{0} นาที"},"short":{"one":"{0} min","other":"{0} นา"},"abbreviated":{"one":"{0} นาที","other":"{0} นาที"}},"hour":{"default":{"one":"{0} hour","other":"{0} ชั่วโมง"},"short":{"one":"{0} hr","other":"{0} ชั่วโมง"},"abbreviated":{"one":"{0} ชม.","other":"{0} ชม."}},"day":{"default":{"one":"{0} day","other":"{0} วัน"},"short":{"one":"{0} day","other":"{0} ว"},"abbreviated":{"one":"{0} วัน","other":"{0} วัน"}},"week":{"default":{"one":"{0} week","other":"{0} สัปดาห์"},"short":{"one":"{0} wk","other":"{0} สัปดาห์"}},"month":{"default":{"one":"{0} month","other":"{0} เดือน"},"short":{"one":"{0} mth","other":"{0} ด"}},"year":{"default":{"one":"{0} year","other":"{0} ปี"},"short":{"one":"{0} yr","other":"{0} ป"}}}};
