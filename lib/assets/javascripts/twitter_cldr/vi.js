...
(function() {
  ...
  TwitterCldr.PluralRules = (function() {
    ...
    PluralRules.rules = {ordinals: (function(num, runtime) { var n = runtime.n(num); var i = runtime.i(num); var v = runtime.v(num); var w = runtime.w(num); var f = runtime.f(num); var t = runtime.t(num); return ((n % 10 == 3 && n % 100 != 13) ? 'few' : (n == 1 ? 'one' : ((n % 10 == 2 && n % 100 != 12) ? 'two' : 'other'))); }), plurals: (function(num, runtime) { var n = runtime.n(num); var i = runtime.i(num); var v = runtime.v(num); var w = runtime.w(num); var f = runtime.f(num); var t = runtime.t(num); return ((i == 1 && v == 0) ? 'one' : 'other'); })};
...
;
  ...
  TwitterCldr.TimespanFormatter = (function() {
    function TimespanFormatter() {
      ...
      this.patterns = {"ago":{"second":{"default":{"one":"{0} second ago","other":"{0} giây trước"}},"minute":{"default":{"one":"{0} minute ago","other":"{0} phút trước"}},"hour":{"default":{"one":"{0} hour ago","other":"{0} giờ trước"}},"day":{"default":{"one":"{0} day ago","other":"{0} ngày trước"}},"week":{"default":{"one":"{0} week ago","other":"{0} tuần trước"}},"month":{"default":{"one":"{0} month ago","other":"{0} tháng trước"}},"year":{"default":{"one":"{0} year ago","other":"{0} năm trước"}}},"until":{"second":{"default":{"one":"In {0} second","other":"Trong {0} giây"}},"minute":{"default":{"one":"In {0} minute","other":"Trong {0} phút"}},"hour":{"default":{"one":"In {0} hour","other":"Trong {0} giờ"}},"day":{"default":{"one":"In {0} day","other":"Trong {0} ngày"}},"week":{"default":{"one":"In {0} week","other":"Trong {0} tuần"}},"month":{"default":{"one":"In {0} month","other":"Trong {0} tháng"}},"year":{"default":{"one":"In {0} year","other":"Trong {0} năm"}}},"none":{"second":{"default":{"one":"{0} second","other":"{0} giây"},"short":{"one":"{0} sec","other":"{0} s"},"abbreviated":{"one":"{0} giây","other":"{0} giây"}},"minute":{"default":{"one":"{0} minute","other":"{0} phút"},"short":{"one":"{0} min","other":"{0} ph"},"abbreviated":{"one":"{0} phút","other":"{0} phút"}},"hour":{"default":{"one":"{0} hour","other":"{0} giờ"},"short":{"one":"{0} hr","other":"{0} g"},"abbreviated":{"one":"{0} giờ","other":"{0} giờ"}},"day":{"default":{"one":"{0} day","other":"{0} ngày"},"short":{"one":"{0} day","other":"{0} ngày"},"abbreviated":{"one":"{0} ngày","other":"{0} ngày"}},"week":{"default":{"one":"{0} week","other":"{0} tuần"},"short":{"one":"{0} wk","other":"{0} tuần"}},"month":{"default":{"one":"{0} month","other":"{0} tháng"},"short":{"one":"{0} mth","other":"{0} tháng"}},"year":{"default":{"one":"{0} year","other":"{0} năm"},"short":{"one":"{0} yr","other":"{0} năm"}}}};
