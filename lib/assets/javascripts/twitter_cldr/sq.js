...
(function() {
  ...
  TwitterCldr.PluralRules = (function() {
    ...
    PluralRules.rules = {ordinals: (function(num, runtime) { var n = runtime.n(num); var i = runtime.i(num); var v = runtime.v(num); var w = runtime.w(num); var f = runtime.f(num); var t = runtime.t(num); return ((n % 10 == 3 && n % 100 != 13) ? 'few' : ((n % 10 == 4 && n % 100 != 14) ? 'many' : (n == 1 ? 'one' : ((n % 10 == 2 && n % 100 != 12) ? 'two' : 'other')))); }), plurals: (function(num, runtime) { var n = runtime.n(num); var i = runtime.i(num); var v = runtime.v(num); var w = runtime.w(num); var f = runtime.f(num); var t = runtime.t(num); return (n == 1 ? 'one' : 'other'); })};
