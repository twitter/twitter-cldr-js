...
(function() {
  ...
  TwitterCldr.TimespanFormatter = (function() {
    function TimespanFormatter() {
      ...
      this.patterns = {"ago":{"second":{"default":{"one":"{0} секунду назад","few":"{0} секунды назад","many":"{0} секунд назад","other":"{0} секунды назад"}},"minute":{"default":{"one":"{0} минуту назад","few":"{0} минуты назад","many":"{0} минут назад","other":"{0} минуты назад"}},"hour":{"default":{"one":"{0} час назад","few":"{0} часа назад","many":"{0} часов назад","other":"{0} часа назад"}},"day":{"default":{"one":"{0} день назад","few":"{0} дня назад","many":"{0} дней назад","other":"{0} дня назад"}},"week":{"default":{"one":"{0} неделю назад","few":"{0} недели назад","many":"{0} недель назад","other":"{0} недели назад"}},"month":{"default":{"one":"{0} месяц назад","few":"{0} месяца назад","many":"{0} месяцев назад","other":"{0} месяца назад"}},"year":{"default":{"one":"{0} год назад","few":"{0} года назад","many":"{0} лет назад","other":"{0} года назад"}}},"until":{"second":{"default":{"one":"Через {0} секунду","few":"Через {0} секунды","many":"Через {0} секунд","other":"Через {0} секунды"}},"minute":{"default":{"one":"Через {0} минуту","few":"Через {0} минуты","many":"Через {0} минут","other":"Через {0} минуты"}},"hour":{"default":{"one":"Через {0} час","few":"Через {0} часа","many":"Через {0} часов","other":"Через {0} часа"}},"day":{"default":{"one":"Через {0} день","few":"Через {0} дня","many":"Через {0} дней","other":"Через {0} дня"}},"week":{"default":{"one":"Через {0} неделю","few":"Через {0} недели","many":"Через {0} недель","other":"Через {0} недели"}},"month":{"default":{"one":"Через {0} месяц","few":"Через {0} месяца","many":"Через {0} месяцев","other":"Через {0} месяца"}},"year":{"default":{"one":"Через {0} год","few":"Через {0} года","many":"Через {0} лет","other":"Через {0} года"}}},"none":{"second":{"default":{"one":"{0} секунда","few":"{0} секунды","many":"{0} секунд","other":"{0} секунды"},"short":{"one":"{0} сек.","few":"{0} сек.","many":"{0} сек.","other":"{0} сек."},"abbreviated":{"one":"{0} сек","few":"{0} сек","many":"{0} сек","other":"{0} сек"}},"minute":{"default":{"one":"{0} минута","few":"{0} минуты","many":"{0} минут","other":"{0} минуты"},"short":{"one":"{0} мин.","few":"{0} мин.","many":"{0} мин.","other":"{0} мин."},"abbreviated":{"one":"{0} мин","few":"{0} мин","many":"{0} мин","other":"{0} мин"}},"hour":{"default":{"one":"{0} час","few":"{0} часа","many":"{0} часов","other":"{0} часа"},"short":{"one":"{0} ч.","few":"{0} ч.","many":"{0} ч.","other":"{0} ч."},"abbreviated":{"one":"{0} ч","few":"{0} ч","many":"{0} ч","other":"{0} ч"}},"day":{"default":{"one":"{0} день","few":"{0} дня","many":"{0} дней","other":"{0} дня"},"short":{"one":"{0} дн.","few":"{0} дн.","many":"{0} дн.","other":"{0} дн."},"abbreviated":{"one":"{0} д","few":"{0} д","many":"{0} д","other":"{0} д"}},"week":{"default":{"one":"{0} неделя","few":"{0} недели","many":"{0} недель","other":"{0} недели"},"short":{"one":"{0} нед.","few":"{0} нед.","many":"{0} нед.","other":"{0} нед."}},"month":{"default":{"one":"{0} месяц","few":"{0} месяца","many":"{0} месяцев","other":"{0} месяца"},"short":{"one":"{0} мес.","few":"{0} мес.","many":"{0} мес.","other":"{0} мес."}},"year":{"default":{"one":"{0} год","few":"{0} года","many":"{0} лет","other":"{0} года"},"short":{"one":"{0} г.","few":"{0} г.","many":"{0} лет","other":"{0} г."}}}};
