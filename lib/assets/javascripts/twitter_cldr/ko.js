...
;
  ...
  TwitterCldr.TimespanFormatter = (function() {
    function TimespanFormatter() {
      ...
      this.patterns = {"ago":{"second":{"default":{"one":"{0} second ago","other":"{0}초 전"}},"minute":{"default":{"one":"{0} minute ago","other":"{0}분 전"}},"hour":{"default":{"one":"{0} hour ago","other":"{0}시간 전"}},"day":{"default":{"one":"{0} day ago","other":"{0}일 전"}},"week":{"default":{"one":"{0} week ago","other":"{0}주 전"}},"month":{"default":{"one":"{0} month ago","other":"{0}개월 전"}},"year":{"default":{"one":"{0} year ago","other":"{0}년 전"}}},"until":{"second":{"default":{"one":"In {0} second","other":"{0}초 후"}},"minute":{"default":{"one":"In {0} minute","other":"{0}분 후"}},"hour":{"default":{"one":"In {0} hour","other":"{0}시간 후"}},"day":{"default":{"one":"In {0} day","other":"{0}일 후"}},"week":{"default":{"one":"In {0} week","other":"{0}주 후"}},"month":{"default":{"one":"In {0} month","other":"{0}개월 후"}},"year":{"default":{"one":"In {0} year","other":"{0}년 후"}}},"none":{"second":{"default":{"one":"{0} second","other":"{0}초"},"short":{"one":"{0} sec","other":"{0}초"},"abbreviated":{"one":"{0}초","other":"{0}초"}},"minute":{"default":{"one":"{0} minute","other":"{0}분"},"short":{"one":"{0} min","other":"{0}분"},"abbreviated":{"one":"{0}분","other":"{0}분"}},"hour":{"default":{"one":"{0} hour","other":"{0}시간"},"short":{"one":"{0} hr","other":"{0}시간"},"abbreviated":{"one":"{0}시","other":"{0}시"}},"day":{"default":{"one":"{0} day","other":"{0}일"},"short":{"one":"{0} day","other":"{0}일"},"abbreviated":{"one":"{0}일","other":"{0}일"}},"week":{"default":{"one":"{0} week","other":"{0}주"},"short":{"one":"{0} wk","other":"{0}주"}},"month":{"default":{"one":"{0} month","other":"{0}개월"},"short":{"one":"{0} mth","other":"{0}개월"}},"year":{"default":{"one":"{0} year","other":"{0}년"},"short":{"one":"{0} yr","other":"{0}년"}}}};
