...
(function() {
  ...
  TwitterCldr.ListFormatter = (function() {
    function ListFormatter(options) {
      ...
      this.formats = {"default":{"2":"{0} und {1}","end":"{0} und {1}","middle":"{0}, {1}","start":"{0}, {1}"},"unit":{"2":"{0} und {1}","end":"{0} und {1}","middle":"{0}, {1}","start":"{0}, {1}"},"unit-narrow":{"2":"{0}, {1}","end":"{0} und {1}","middle":"{0}, {1}","start":"{0}, {1}"},"unit-short":{"2":"{0}, {1}","end":"{0} und {1}","middle":"{0}, {1}","start":"{0}, {1}"}};
    }
