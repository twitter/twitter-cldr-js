...
(function() {
  ...
  TwitterCldr.TimespanFormatter = (function() {
    function TimespanFormatter() {
      ...
      this.patterns = {"ago":{"second":{"default":{"other":"{0} saniye önce"}},"minute":{"default":{"other":"{0} dakika önce"}},"hour":{"default":{"other":"{0} saat önce"}},"day":{"default":{"other":"{0} gün önce"}},"week":{"default":{"other":"{0} hafta önce"}},"month":{"default":{"other":"{0} ay önce"}},"year":{"default":{"other":"{0} yıl önce"}}},"until":{"second":{"default":{"other":"{0} saniye sonra"}},"minute":{"default":{"other":"{0} dakika sonra"}},"hour":{"default":{"other":"{0} saat sonra"}},"day":{"default":{"other":"{0} gün sonra"}},"week":{"default":{"other":"{0} hafta sonra"}},"month":{"default":{"other":"{0} ay sonra"}},"year":{"default":{"other":"{0} yıl sonra"}}},"none":{"second":{"default":{"other":"{0} saniye"},"short":{"other":"{0} sn."},"abbreviated":{"other":"{0} sn"}},"minute":{"default":{"other":"{0} dakika"},"short":{"other":"{0} dk."},"abbreviated":{"other":"{0} dk"}},"hour":{"default":{"other":"{0} saat"},"short":{"other":"{0} sa."},"abbreviated":{"other":"{0} sa"}},"day":{"default":{"other":"{0} gün"},"short":{"other":"{0} gün"},"abbreviated":{"other":"{0} gün"}},"week":{"default":{"other":"{0} hafta"},"short":{"other":"{0} hf."}},"month":{"default":{"other":"{0} ay"},"short":{"other":"{0} ay"}},"year":{"default":{"other":"{0} yıl"},"short":{"other":"{0} yıl"}}}};
