...
(function() {
  ...
  TwitterCldr.PluralRules = (function() {
    ...
    PluralRules.rules = {cardinal: (function(num, runtime) { var n = runtime.__n(num); var i = runtime.__i(num); var v = runtime.__v(num); var w = runtime.__w(num); var f = runtime.__f(num); var t = runtime.__t(num); return (((v == 0 && ((i % 10 >= 2) && (i % 10 <= 4))) && !((i % 100 >= 12) && (i % 100 <= 14))) ? 'few' : ((((v == 0 && i % 10 == 0) || (v == 0 && ((i % 10 >= 5) && (i % 10 <= 9)))) || (v == 0 && ((i % 100 >= 11) && (i % 100 <= 14)))) ? 'many' : (((v == 0 && i % 10 == 1) && i % 100 != 11) ? 'one' : 'other'))); }), ordinal: (function(num, runtime) { var n = runtime.__n(num); var i = runtime.__i(num); var v = runtime.__v(num); var w = runtime.__w(num); var f = runtime.__f(num); var t = runtime.__t(num); return 'other'; })};

    PluralRules.runtime = (function() {
  this.buildArgsFor = function(num_str) {
    return [
      this.__n(num_str), this.__i(num_str), this.__f(num_str),
      this.__t(num_str), this.__v(num_str), this.__w(num_str)
    ];
  }

  this.__n = function(str) {
    if (str.indexOf('.') > -1) {
...
;
  ...
  TwitterCldr.RBNFNormalRuleFormatter = (function() {
    ...
    RBNFNormalRuleFormatter.prototype.plural = function(number, rule, token) {
      return token.render(number / rule.divisor);
    };
